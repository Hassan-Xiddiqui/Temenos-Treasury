...
//        PageObject.textinput_Locator("fieldName:DEALER.DESK",column.get("DEALER_DESK"));
        ...
        PageObject.textinput_Locator("fieldName:SPOT.RATE",column.get("SPOT_RATE"));
        ...
        PageObject.click_Locator("fieldName:SWIFT.BIC");
        Thread.sleep(2000);
//        PageObject.textinput_Locator("fieldName:BROKERAGE.AMOUNT",column.get("BROKERAGE_AMOUNT"));
//        PageObject.select_Locator("fieldName:CONF.BY.CPARTY",column.get("CONF_BY_CPARTY"));
...
//        PageObject.radiobutton_Locator("radio:tab1:IS.FXCRS",1);
        ...
        PageObject.commitDealIBG("spotDeal");
...
//        PageObject.textinput_Locator("value:1:1:1","768787");
    ...
    public static void saveToDS(String testCaseName) throws IOException {
        File file = new File(System.getProperty("user.dir") + "\\Excel Data\\IBG\\spotDeal.xlsx");
    ...
    public Object[][] data() throws IOException {
        String FILE_PATH = System.getProperty("user.dir")+"\\Excel Data\\IBG\\ForexSpot.xlsx";
    ...
    public Object[][] Unauth() throws IOException {
        String FILE_PATH = System.getProperty("user.dir")+"\\Data\\IBG\\spotDeal.xlsx";
        FileInputStream fis = new FileInputStream(FILE_PATH);
        Workbook workbook = new XSSFWorkbook(fis);
        Sheet sheet = workbook.getSheetAt(0); // Assuming data is in the first sheet
        int rowCount = sheet.getPhysicalNumberOfRows();
