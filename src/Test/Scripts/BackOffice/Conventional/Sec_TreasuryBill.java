...
public class Sec_TreasuryBill extends BaseClass {

    @Test(groups = {"BOInputter"}, dataProvider = "TBillData")
    public void TBill(Map<String, String> testData) throws IOException, InterruptedException {
        ...
        PageObject.menu_Link("Treasury Bill (T-Bill) Maintenance  ");
...
//        PageObject.textinput_Locator("fieldName:INTEREST.RATE:1","6.00");
        ...
        PageObject.commitDeal("Sec_TBill_Txn");

    }

    @DataProvider(name = "TBillData")
    public Object[][] readExcelData_1() throws IOException {
        String FILE_PATH = System.getProperty("user.dir")+"\\Excel Data\\Sec_BackOffice_TreasuryBill.xlsx";
