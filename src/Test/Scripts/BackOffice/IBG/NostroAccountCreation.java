...
public class NostroAccountCreation extends BaseClass {
    ...
    @Test(groups = {"BOInputterIBG"}, dataProvider = "NostroAccountCreation")
    public void NostroAccountCreation(Map<String, String> testData) throws IOException, InterruptedException {
        ...
        PageObject.menu_Dropdown("Account Menu ",1);
        ...
        PageObject.commitDealIBG("IBG_NostroAccountCreation");
    ...
    @Test(groups = {"IBGAuthorizer"}, dataProvider = "NostroAccountCreation_Authorization")
...
//        PageObject.switchFrame(1);
    ...
    public Object[][] readExcelData_1A() throws IOException {
        String FILE_PATH = System.getProperty("user.dir")+"\\Data\\IBG\\IBG_NostroAccountCreation.xlsx";
