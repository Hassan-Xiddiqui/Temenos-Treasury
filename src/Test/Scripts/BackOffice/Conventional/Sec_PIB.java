...
public class Sec_PIB extends BaseClass {

    @Test(groups = {"BOInputter"}, dataProvider = "PakistanInvestmentBondMaintenance")
    public void PakistanInvestmentBondMaintenance(Map<String, String> testData) throws IOException, InterruptedException {
        ...
        PageObject.menu_Link("Pakistan Investment Bond (PIB) Maintenance  ");
        ...
        PageObject.commitDeal("PakistanInvestmentBondMaintenance");

    }

    @DataProvider(name = "PakistanInvestmentBondMaintenance")
    public Object[][] readExcelData_1() throws IOException {
        String FILE_PATH = System.getProperty("user.dir")+"\\Excel Data\\PakistanInvestmentBondMaintenance.xlsx";
