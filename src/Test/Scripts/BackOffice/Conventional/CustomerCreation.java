...
import static POM.PageObject.driver;



//clear Txn data set of following Transactions before running BO test cases:
//
//        CustomerCreation
//        CounterPartyLimit
//        CounterPartyLimitChild
//        FT
//        update value of TransactionID for SAM script.

public class CustomerCreation extends BaseClass {
    @Test(groups = {"BOInputter"}, dataProvider = "CustomerCreation")
    public void CustomerCreation(Map<String, String> testData) throws IOException, InterruptedException {
        ...
        String Mnemonic = testData.get("Mnemonic");
        ...
        PageObject.menu_Link("Customer Opening  ");
...
//        PageObject.textinput_Locator("fieldName:MNEMONIC",Mnemonic+String.valueOf(PageObject.idNumber(100,999)));
        ...
        PageObject.select_Locator("fieldName:CUST.SEGMENT",testData.get(""));
        ...
        * */
        ...
        PageObject.commitDeal("CustomerCreation");

    }

    @DataProvider(name = "CustomerCreation")
    public Object[][] readExcelData_1() throws IOException {
        String FILE_PATH = System.getProperty("user.dir")+"\\Excel Data\\CustomerCreation.xlsx";
    ...
    @Test(groups = {"BOAuthorizer"}, dataProvider = "CustomerCreation_Authorization")
