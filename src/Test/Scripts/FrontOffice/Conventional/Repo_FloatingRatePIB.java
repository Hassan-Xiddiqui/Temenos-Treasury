...
public class Repo_FloatingRatePIB extends BaseClass {
    String FILE_PATH = System.getProperty("user.dir") + "\\Excel Data\\FloatingRateRepoPIB.xlsx";

    @Test(groups = {"Inputter"}, dataProvider = "excelDataFloatingRateRepoPIB")
    public static void FloatingRateRepoPIB(Map<String, String> testData) throws IOException, InterruptedException {

        PageObject.menu_Dropdown("Capture Current Repo deals");
        PageObject.menu_Dropdown("Deal (Floating Rate Repo/Reverse Repo)");
        PageObject.menu_Link("Floating Rate Repo PIB ");
...
//        PageObject.textinput_Locator("fieldName:VALUE.DATE", testData.get("VALUE.DATE"));
        ...
        PageObject.radiobutton_Locator("radio:tab1:DEAL.MODE", Integer.parseInt(testData.get("DEAL.MODE")));
        PageObject.radiobutton_Locator("radio:tab1:DEAL.MODE", Integer.parseInt(testData.get("DEAL.MODE")));
        PageObject.textinput_Locator("fieldName:DEAL.METHOD",testData.get("DEAL.METHOD"));

        // menu = PageObject.switchToChildWindow();
        PageObject.commitDeal("RepoPIBs");

    }

    @DataProvider(name = "excelDataFloatingRateRepoPIB")
...
//        rowCount-=2;
    ...
    String FILE_PATH2 = System.getProperty("user.dir") + "\\Data\\RepoPIBs.xlsx";

    @Test (groups = {"BOAuthorizer"}, dataProvider = "DataFloatingRateRepoPIB")
    public static void FloatingRateRepoPIBAuth(Map<String, String> testData) throws IOException {
...
//        PageObject.menu_Dropdown("Auth/Modify/Rev/Del Forex Deals ");
        PageObject.menu_Link("Repo Pakistan Investment Bonds  ");
...
//        PageObject.img_Button("Select Drilldown");
    ...
    @DataProvider(name = "DataFloatingRateRepoPIB")
