...
public class Sec_TFC extends BaseClass {

    @Test(groups = {"BOInputter"}, dataProvider = "TFCData")
    public void TFC(Map<String, String> testData) throws IOException, InterruptedException {
        ...
        PageObject.menu_Link("Term Finance Certificate (TFC) Maintenance  ");
        ...
        PageObject.textinput_Locator("fieldName:INTEREST.RATE:1",testData.get("InterestRate"));

        PageObject.textinput_Locator("fieldName:COMPANY.DOMICILE",testData.get("DOMICILE"));
        PageObject.textinput_Locator("fieldName:SECURITY.CURRENCY",testData.get("CURRENCY"));
        PageObject.textinput_Locator("fieldName:INDUSTRY.CODE",testData.get("Icode"));
        PageObject.radiobutton_Locator("radio:mainTab:YES.NO",2);

        PageObject.form_Tab("Cpn and Tax");
        PageObject.textinput_Locator("fieldName:INT.PAYMENT.DATE","20230101");
        PageObject.select_Locator("fieldName:INTEREST.DAY.BASIS","D 360/366");

        PageObject.commitDeal("Sec_BackOffice_TFCTxnNumber");

    }

    @DataProvider(name = "TFCData")
    public Object[][] readExcelData_1() throws IOException {
        String FILE_PATH = System.getProperty("user.dir")+"\\Excel Data\\Sec_BackOffice_TFC.xlsx";
