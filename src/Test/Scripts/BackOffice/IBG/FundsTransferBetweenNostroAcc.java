...
public class FundsTransferBetweenNostroAcc extends BaseClass {

    @Test(groups = {"BOInputterIBG"}, dataProvider = "FundsTransferBetweenNostroAcc")
    public void FundsTransferBetweenNostroAcc(Map<String, String> testData) throws IOException, InterruptedException {
        ...
        PageObject.menu_Link("Funds Transfer ",4);
        ...
        PageObject.commitDealIBG("IBG_FundsTransferBetweenNostroAcc");

    }

    @DataProvider(name = "FundsTransferBetweenNostroAcc")
    public Object[][] readExcelData_1() throws IOException {
        String FILE_PATH = System.getProperty("user.dir")+"\\Excel Data\\IBG\\IBG_FundsTransferBetweenNostroAcc.xlsx";
    ...
    @Test(groups = {"IBGAuthorizer"}, dataProvider = "FundsTransferBetweenNostroAcc_Authorization")
    public void FundsTransferBetweenNostroAcc_Authorization(Map<String, String> testData) throws IOException, InterruptedException {
...
//        PageObject.switchFrame(1);
    ...
    @DataProvider(name = "FundsTransferBetweenNostroAcc_Authorization")
    public Object[][] readExcelData_1A() throws IOException {
        String FILE_PATH = System.getProperty("user.dir")+"\\Data\\IBG\\IBG_FundsTransferBetweenNostroAcc.xlsx";
