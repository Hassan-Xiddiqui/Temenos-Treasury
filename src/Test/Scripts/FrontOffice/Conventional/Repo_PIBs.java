...
public class Repo_PIBs extends BaseClass {

    String FILE_PATH = System.getProperty("user.dir") + "\\Excel Data\\RepoPIBs.xlsx";

    @Test(groups = {"Inputter"}, dataProvider = "excelDataRepoPIBs")
    public static void RepoPIBs(Map<String, String> testData) throws IOException, InterruptedException {

        PageObject.menu_Dropdown("Capture Current Repo deals");
        PageObject.menu_Dropdown("Deals (PIBS/TBILLS) ");
        PageObject.menu_Link("Repo PIB" , 1);
...
//        PageObject.textinput_Locator("fieldName:VALUE.DATE", testData.get("VALUE.DATE"));
    ...
    @DataProvider(name = "excelDataRepoPIBs")
...
//        rowCount-=2;
    ...
    @Test (groups = {"BOAuthorizer"}, dataProvider = "DataRepoPIBs")
    public static void RepoPIBsAuth(Map<String, String> testData) throws IOException {
...
//        PageObject.img_Button("Select Drilldown");
    ...
    @DataProvider(name = "DataRepoPIBs")
