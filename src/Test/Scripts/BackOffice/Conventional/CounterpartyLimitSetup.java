...
public class CounterpartyLimitSetup extends BaseClass {
    ...
    @Test(groups = {"BOLimitInput"}, dataProvider = "CounterpartyLimitSetup")
    public void CounterpartyLimitSetup(Map<String, String> testData) throws IOException, InterruptedException {
        ...
        PageObject.textinput_Locator("transactionId",CustomerID+".0030000.03");
    ...
    @Test(groups = {"BOLimitAuth"}, dataProvider = "CounterpartyLimitSetup_Authorization")
    ...
    public Object[][] readExcelData_1A() throws IOException {
        String FILE_PATH = System.getProperty("user.dir")+"\\Data\\CounterpartyLimitSetup.xlsx";
    ...
    public void CounterpartyLimitSetupChild(Map<String, String> testData) throws IOException, InterruptedException {
        ...
        PageObject.textinput_Locator("transactionId",CustomerID+".0001400.01");
        PageObject.img_Button("Edit a contract");

        PageObject.textinput_Locator("fieldName:LIMIT.CURRENCY","PKR");
//        PageObject.textinput_Locator("fieldName:PRODUCT.ALLOWED:1","");
        PageObject.textinput_Locator("fieldName:INTERNAL.AMOUNT","1B");
        PageObject.textinput_Locator("fieldName:MAXIMUM.TOTAL","1B");
        PageObject.textinput_Locator("fieldName:ADVISED.AMOUNT","1B");
        PageObject.radiobutton_Locator("radio:tab1:ALLOW.NETTING",1);
        PageObject.commitDeal("CounterpartyLimitSetupChild");
    ...
    @Test(groups = {"BOLimitAuth"}, dataProvider = "CounterpartyLimitSetupChild_Authorization")
    public void CounterpartyLimitSetupChild_Authorization(Map<String, String> testData) throws IOException, InterruptedException {
    ...
    public Object[][] readExcelData_2A() throws IOException {
        String FILE_PATH = System.getProperty("user.dir")+"\\Data\\CounterpartyLimitSetupChild.xlsx";
